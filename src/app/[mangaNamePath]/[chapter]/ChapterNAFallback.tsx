...
import Img404 from '@/assets/images/manganest_404_img.png';
  ...
  return (
    <div className="flex flex-col items-center md:flex-row md:items-start">
      ...
      <div className="mt-10 flex flex-col items-center md:items-start">
        ...
        <p className="mt-3 font-heading text-2xl">This chapter is not avaialable!</p>
        <p className="mt-3 text-center font-body md:mt-7 md:text-start">
